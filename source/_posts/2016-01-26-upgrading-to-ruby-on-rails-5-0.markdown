...
**Edit: In this post we're upgrading an application to Rails 5.0.0.beta1.1 and [Rails 5.0.0.beta2 is now already released](http://weblog.rubyonrails.org/2016/2/2/Rails-5-0-beta2/).
